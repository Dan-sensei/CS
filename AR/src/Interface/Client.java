...
public class Client extends javax.swing.JFrame {
    ...
    private HashMap<String,String> clave;
    ...
    public Client() {
        ...
        // SI ES EMISOR
        String AESkey = "Bar12345Bar12345";
        String AESenc = RSAencrypt(AESkey, destination.PublicKey);
        
        clave.put(destination, AESkey);
        
        
        // SI ES RECEPTOR
        String AESkey = RSAdecrypt(mensaje, PrivateKey);
        
        String initVector = "8u87y6t5r4efghyt";
        
        Screen.setEditable(false);
        Input.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent e){
                outer.println(destination);
                outer.println(encryptAES(AESkey, initVector, Input.getText()));
        ...
        while(true){
            ...
            if (x.startsWith("SUBMITNAME")) {
               // user=getUserName();
                ...
                if (conexion == false) {    // SI LOS 2 TIENEN LA MISMA CLAVE AES?
